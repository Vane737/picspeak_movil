    ...
    return Scaffold(
      body: Container(
          ...
          children: [
            ...
            const CustomTitle(headingText: 'Intereses', styles: AppFonts.heading1Style),
  ...
  Widget build(BuildContext context) {
    return  Column(
          children: [
              ...
              const CustomTitle(headingText: '¿Qué tipo de intereses tienes?', styles: AppFonts.heading2Style),
